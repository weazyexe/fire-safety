...
public class ToolbarConfig {
    ...
    public ToolbarConfig setDisplayShowTitleEnabled(boolean showTitle) {
    ...
    private void configToolbar(Toolbar toolbar) {
        ...
        configDisplayShowTitleEnabled(activity.getSupportActionBar());
    ...
    private void configDisplayShowTitleEnabled(ActionBar actionBar) {
        if (actionBar != null) {
